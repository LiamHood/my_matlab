...
plot3(yplot1, yplot2, yplot3, '-r', 'LineWidth', 1);

xlabel('X coordinate (R_L)', 'FontSize', 12);

ylabel('Y coordinate (R_L)', 'FontSize', 12);

zlabel('Z coordinate (R_L)', 'FontSize', 12);
