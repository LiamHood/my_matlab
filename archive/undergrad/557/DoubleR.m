%% Double R
%----------------------------------------------------------------------
    function [ r2vec , v2vec , r1vec , r3vec ] = DoubleR( qhat1 , qhat2 , qhat3 , R1 , R2 , R3 , tau1 , tau3 )
        ...
        Err = 1;
        while Err > .001
            [F1,F2,f,g,r3vec,r2vec,r1vec]=AERO557drfunc(c1,c2,r1,r2,tau1,tau3,qhat1,qhat2,qhat3,R1,R2,R3);
            dr1 = .005*r1;
            dr2 = .005*r2;
        ...
        %% double R function
    function [F1,F2,f,g,r3vec,r2vec,r1vec]=AERO557drfunc(c1,c2,r1,r2,tau1,tau3,qhat1,qhat2,qhat3,R1,R2,R3)
