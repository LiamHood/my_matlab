...
busmass = 2 ; % mass of bus in kg
magdi = [ 0 0 -0.5 ] ; % magnetic dipole moment A*m^2
sensmass = 1 ; % sensor mass
...
% title( 'NRLMSISE-00 Model: Magnitude of Torques on S/C' )
% xlabel( 'Time [Hours]' )
% ylabel( 'Torque [N-m]' )
...
title( 'Simple Atmosphere: Magnitude of Torques on S/C' )
xlabel( 'Time [Hours]' )
ylabel( 'Torque [N-m]' )
% legend( 'Drag Torque' , 'SRP' , 'Gravity Gradient' , 'Magnetic' , 'Location' , 'eastoutside' )
