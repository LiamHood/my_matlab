...
hold on
plot3(state_new1(:,1), state_new1(:,2), state_new1(:,3) ,'-k')
...
hphase_meo = sqrt(ra_phasemeo*mu*(1-eccphase_meo)) ; % specific angular momentum of the phase orbit
                ...
                hold on
                plot3(statenewphase(:,1), statenewphase(:,2), statenewphase(:,3) ,'-g')
...
%Meo plot
hold on
plot3(state_meo2(:,1), state_meo2(:,2), state_meo2(:,3) , '-r' )
%Animated line plot either use plot3 or code below
...
[t_new7 ,state_leo1] = ode45(@OrbitStep, t_span, state_leo1, options, mu);
 %hold on
 %plot3(state_leo1(:,1), state_leo1(:,2), state_leo1(:,3) ,  '-c' )
 %Animated line plot either use plot3 or code below
...
h_trans2 = sqrt(ra_ellipse*mu*(1-e_trans2)) ; % specific angular momentum of 2nd transfer ellipse
                ...
                % COEs and state of first ellipse
                TA_trans2 = 180 ;
                [~,~,r_ellipse2,v_ellipse2] = COEs2State(e_trans2, inc2 , RAAN2, ArgPer2, h_trans2, TA_trans2, mu) ;
                state_ellipse2o = [ r_ellipse2 ; v_ellipse2 ] ;
                t_ellipse2 = [ 0 , T_trans2 ];
                [t_ellipse1 , state_ellipse2] = ode45(@OrbitStep, t_ellipse2, state_ellipse2o, options, mu);                  

                
                plot3( state_ellipse1(:,1) , state_ellipse1(:,2) , state_ellipse1(:,3) , '-b' )
                plot3( state_ellipse2(:,1) , state_ellipse2(:,2) , state_ellipse2(:,3) , '-b' )
...
hold on
plot3(state_4(:,1), state_4(:,2), state_4(:,3) , '-r')
...
hold on
plot3(state_L2L(:,1), state_L2L(:,2), state_L2L(:,3) , '-k' ) 
