...
%% Tests
load("Data_ft3.mat")
filters = (Cessnafull.vZ__ms)<500 & (Cessnafull.vZ__ms)>-500 ...
    & Cessnafull.alt_1ftmsl < 5200 & Cessnafull.alt_1ftmsl > 4800;
velocity = Cessnafull.Vtrue_ktas(filters);
% figure
% plot(Cessnafull.Vind_kias,'.')

xvec = [631,695,777,855,979];

for ii = 1:5
    table2(ii,:) = printItem2(Cessnafull,xvec(ii),ii);
end
disp(table2)
...
BHP = [106,109,114,126,138];
for ii = 1:5
    table3(ii,:) = printItem3(Cessnafull,xvec(ii),table2(ii,:),BHP(ii));
end
